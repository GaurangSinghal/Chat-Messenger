...
public class viewreview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       rootview = inflater.inflate(R.layout.fragment_viewreview, container, false);
    ...
    private void populatelistview()
    {
        ...
        ListView lv = (ListView)rootview.findViewById(R.id.listViewuserfeedback);
    ...
    private class Mylistadapter extends ArrayAdapter<feedbackquestiontouser>
    {
        ...
        {
            super(getActivity(),R.layout.feedbackdatauser,data);
        }
        ...
        public View getView(int position,View convertView,ViewGroup parent)
        {
            ...
            if(itemview==null)
            {
                ...
                itemview=((Activity)getContext()).getLayoutInflater().inflate(R.layout.feedbackdatauser,parent,false);
            }
