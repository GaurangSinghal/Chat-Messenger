...
public class fragmentofedit extends Fragment {
    View rootview;
    TextView tv;
    View viewuser,vv;
    ImageView im1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_fragmentofedit, container, false);
    ...
    private void populatelistview()
    {
        ...
        ListView lv = (ListView)rootview.findViewById(R.id.listViewedit);
    ...
    private class Mylistadapter extends ArrayAdapter<feedbackquestiontouser>
    {
        ...
        {
            super(getActivity(),R.layout.editxmlpage,data);
        }
        ...
        public View getView(int position,View convertView,ViewGroup parent)
        {
            ...
            if(itemview==null)
            {
                ...
                itemview=((Activity)getContext()).getLayoutInflater().inflate(R.layout.editxmlpage,parent,false);
            }
